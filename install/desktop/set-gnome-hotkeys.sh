...
gsettings set org.gnome.desktop.wm.keybindings toggle-fullscreen "['<Shift>F12']"
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom2/ binding '<Shift><Super>F2'
